...
<div class="big-title-accueil container-fluid">
    ...
    <h1 class="text-center">Julie et José vous souhaitent la bienvenue chez</h1>
...
<div class="presentation container-fluid text-center mb-4 mt-4 pt-4 pb-4">
    ...
    <div class="text-presentation pb-1">
        <p>Portée par Julie et José, notre équipe met son professionnalisme au service de vos événements depuis 25 ans. Des repas de fêtes aux grandes célébrations en passant par les évenements professionnels, nous proposons des menus savoureux en constante évolution, adaptés à tous les régimes.</p>
        <p>Profitez de notre savoir-faire artisanal et d'une commande simplifiée pour faire de vos réceptions un moment gastronomique d’exception en toute facilité.</p>
    </div>
